...
void LveDevice::createInstance() {
    ...
    appInfo.pApplicationName = "Little Vertex Engine";
...
void LveDevice::pickPhysicalDevice(){
    ...
    if(deviceCount == 0){
        throw std::runtime_error("failed finding compatible GPU");
    }
...
uint32_t LveDevice::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties){
    ...
    throw std::runtime_error("failes to find suitable memory type");
}
